                                    ...
                                    <div class="row">
                                        <div class="el-wrapper">
                                            ...
                                            <div class="flex flex-row justify-between">
                                                <button type="button" class="block animate-pulse mx-auto h-16 w-64 flex justify-center items-center" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="handleDelete(<?php echo $row['Id']; ?>)">
