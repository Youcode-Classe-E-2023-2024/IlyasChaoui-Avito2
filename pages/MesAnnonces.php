...
$_SESSION['num_annonce'] = mysqli_num_rows($result);
    ...
    <div class="my- shell relative">
                            ...
                            <div class="row">
                                <div class="el-wrapper">
                                    ...
                                    <div class="flex flex-row justify-between">
                                        <button type="button"
                                            class="block animate-pulse mx-auto h-16 w-64 flex justify-center items-center"
                                            data-bs-toggle="modal" data-bs-target="#exampleModal"
                                            onclick="handleDelete(<?php echo $row['Id']; ?>)">
                                            <div
                                                class="i h-12 w-20 bg-red-500 items-center rounded-2xl shadow-2xl cursor-pointer absolute overflow-hidden transform hover:scale-x-110 hover:scale-y-105 transition duration-300 ease-out">
                                            </div>
                                            <span
                                                class="text-center text-white font-semibold z-50 pointer-events-none">Delete</span>
                                        </button>

                                        <a href="http://localhost/IlyasChaoui-Avito2/pages/EditAnnonce.php?Id=<?php echo $row['Id']; ?>"
                                            class="block animate-pulse mx-auto h-16 w-64 flex justify-center items-center">
                                            <div
                                                class="i h-12 w-20 bg-blue-500 items-center rounded-2xl shadow-2xl cursor-pointer absolute overflow-hidden transform hover:scale-x-110 hover:scale-y-105 transition duration-300 ease-out">
                                            </div>
                                            <span
                                                class="text-center text-white font-semibold z-50 pointer-events-none">EDIT</span>
                                        </a>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form action="../includes/Annonce_crud/Delete.php" method="POST">
                    ...
                    <div class="-mx-4 flex flex-wrap justify-between">
                        <div class="px-4 my-4 w-full xl:w-1/5">
                            ...
                            <p class="text-justify">
                                ...
                                Components gives you all of the building blocks you need to build any designs without
