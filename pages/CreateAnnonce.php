...
<body>
        ...
        <header class="h-16 w-full flex items-center relative justify-end px-5 space-x-10 bg-gray-800">
            ...
            <div class="flex flex-shrink-0 items-center space-x-4 text-white">
                <a href="./CreateAnnonce.php">
                    <div class="b relative mx-24 h-10 w-36 flex justify-center items-center ">
                        ...
                        <span class="text-center text-white font-semibold z-10 pointer-events-none">Create annonce!</span>
    ...
    <aside class="h-screen z-20 fixed w-16 flex flex-col space-y-10 items-center justify-center  bg-gray-800 text-white">
        ...
        <div class="logout-btn">
            <a href="../includes/logout.php" class=" mx-3 hover:text-red-100  px-2 py-2 text-white cursor-pointer "><i class="fa-solid fa-right-from-bracket " style="color: #ffffff;  "></i></a>
        </div>
    </aside>m
