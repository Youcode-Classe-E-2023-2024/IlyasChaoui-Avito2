                    ...
                    <div class="mt-5 bg-white rounded-lg shadow">
                        <div class="flex">
                            <div class="flex-1 py-5 pl-5 overflow-hidden">
                                ...
                                <div class="px-5 pb-5">
                                    <input type="text" name="user_name" value="<?php echo $_SESSION['username']; ?>" placeholder="Username" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                    <input type="hidden" value="<?php echo $_SESSION['user'] ?>" name="user_id">
                                    <div class="flex">
                                        <div class="flex-grow w-1/4 pr-2"><input placeholder="Phone_number" value="<?php echo $_SESSION['PhoneNumber']; ?>" name="user_phone" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                        </div>
                                        <!-- <div class="flex-grow"><input type="text" name="user_role"  value="<?php echo $_SESSION['role']; ?>" placeholder="Role" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                </div>
                            </div> -->
                                        <select class="role-label" id="gender" name="role">
                                            <!-- <option value="<?php echo $_SESSION['role'] ?>">Viewer</option> -->
                                            <option value="Viewer">Viewer</option>
                                            <option value="Annoncer">Annoncer</option>
                                        </select>
                                        <input type="text" name="user_email" value="<?php echo $_SESSION['Email']; ?>" placeholder="Email" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                    </div>
                                    <hr class="mt-4">
