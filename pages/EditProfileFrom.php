...
<body>
    ...
    <!-- component -->
    <form class="space-y-6" action="../includes/Profile_crud/UpdateProfile.php" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <div class="mt-5 bg-white rounded-lg shadow">
                        ...
                        <div class="px-5 pb-5">
                            ...
                            <div class="flex">
                                <div class="flex-grow w-1/4 pr-2"><input type="number" min=0 name="phone_number" placeholder="phone" value="<?php echo $_SESSION['PhoneNumber']; ?>" readonly class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                </div>
                                <div class="flex-grow w-1/4 pr-2">
                                    <p readonly class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400"><input type="hidden" name="user_role" value="<?php echo $_SESSION['role']; ?>"><?php echo $_SESSION['role']; ?></p>
                                </div>
                            </div>
                            <input type="text" name="description" placeholder="Description" value="<?php echo $_SESSION['Email']; ?>" readonly class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                        </div>
                        <div class="flex">
                            <div class="flex-1 py-5 pl-5 overflow-hidden">
                        ...
                        <div class="px-5 pb-5">
                            <input type="text" name="user_name" placeholder="Username" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                            <input type="hidden" value="<?php echo $_SESSION['user'] ?>" name="user_id">
                            <div class="flex">
                                <div class="flex-grow w-1/4 pr-2"><input placeholder="Phone_number" name="user_phone" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                </div>
                                <div class="flex-grow"><input type="text" name="user_role" readonly value="<?php echo $_SESSION['role']; ?>" placeholder="Role" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                </div>
                            </div>
                            <input type="text" name="user_email" placeholder="Email" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                        </div>
                        <hr class="mt-4">
                        <div class="flex flex-row-reverse p-3">
                            ...
                            <div class="flex-initial">
                                <button type="submit" class="pl-2 mx-1">Save</button>
                            </div>
                        </div>
                    </div>
                </div>
